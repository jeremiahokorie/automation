...
<head>
    ...
    <title>Welcome to MDA Portal</title>
    <style>
        @media  all {
            /* cyrillic-ext */
            @font-face {
            ...
            <table class="pc-project-container" style="width: 600px; max-width: 600px;" width="600" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td style="padding: 0px;" align="left" valign="top">
                        <!-- Official State Banner Header with Bauchi State Logo -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                                <td style="padding: 0px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td valign="top" style="background-color: #003366; padding: 20px 40px; border-bottom: 5px solid #FFCC00;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="80" valign="middle">
                                                            <!-- Bauchi State Logo -->
                                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Coat_of_arms_of_Bauchi_State.png/1200px-Coat_of_arms_of_Bauchi_State.png" alt="Bauchi State Logo" width="80" height="80" style="display: block; border: none;">
                                                        </td>
                                                        <td valign="middle" style="padding-left: 20px;">
                                                            <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="text-block-td pc-font-alt" style="mso-line-height: exactly;line-height: 1.2;font-family: 'Georgia', serif;font-size: 24px;font-weight: bold;color: #FFFFFF;text-align: left;">
                                                                        BAUCHI STATE GOVERNMENT<br>
                                                                        <span style="font-size: 18px; font-weight: normal;">MINISTRY OF DEVELOPMENT AFFAIRS</span>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                        ...
                        <!-- Welcome Content -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="background-color: #FFFFFF;">
                            <tr>
                                <td style="padding: 40px 40px 20px 40px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top" class="pc-font-alt" style="mso-line-height: exactly;line-height: 1.5;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 18px;font-weight: normal;color: #333333;text-align: left;">
                                                <p style="margin: 0 0 20px 0;">Dear ${name},</p>
                                                <p style="margin: 0 0 20px 0;">Welcome to the Bauchi State Ministry of Development Affairs (MDA) Automation Portal. Your account has been successfully created.</p>
                                                <p style="margin: 0 0 20px 0;">This portal provides access to essential government services and resources to help streamline your interactions with our ministry.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="background-color: #FFFFFF;">
                            <tr>
                                <td style="padding: 0px 40px 30px 40px;" align="center">
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="border-radius: 4px;" bgcolor="#003366">
                                                <a href="https://bauchi-mda.netlify.app/login" target="_blank" style="display: inline-block; padding: 12px 30px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; font-weight: bold; border-radius: 4px;">Login to continue</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="background-color: #F8F8F8; border-top: 1px solid #E0E0E0;">
                            <tr>
                                <td style="padding: 30px 40px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top" class="pc-font-alt" style="mso-line-height: exactly;line-height: 1.5;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 14px;font-weight: normal;color: #555555;text-align: left;">
                                                <p style="margin: 0 0 15px 0; font-weight: bold;">Need Assistance?</p>
                                                <p style="margin: 0 0 15px 0;">If you have any questions or need help accessing your account, please contact our support team at <a href="mailto:support@mda.bauchi.gov.ng" style="color: #003366; text-decoration: underline;">support@mda.bauchi.gov.ng</a> or call (123) 456-7890 during business hours.</p>
                                                <p style="margin: 0;">Office Hours: Monday-Friday, 8:00 AM - 5:00 PM</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <!-- Footer -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="background-color: #003366;">
                            <tr>
                                        ...
                                        <tr>
                                            <td valign="top" align="center" class="pc-font-alt" style="mso-line-height: exactly;line-height: 1.5;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 12px;font-weight: normal;color: #FFFFFF;text-align: center;">
                                                ...
                                                <p style="margin: 0;">
                                                    ...
                                                    <a href="#" style="color: #FFFFFF; text-decoration: underline; margin: 0 10px;">Accessibility</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
